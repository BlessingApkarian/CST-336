function printContact(contact) {
    ...
    var pictureColumnDiv = document.createElement("img");
    pictureColumnDiv.setAttribute("class", "col-12 col-sm-6 col-md-3 px-0");
    contactList.appendChild(pictureColumnDiv);
    ...
    //     <span class = "fa fa-mobile fa-2x text-sucess float-right pulse" title = "online now"></span>
    ...
    //     <label class = "name lead">Mile Anamendolla</label>
    ...
    addressActionSpan.setAttribute("class", "a fa-map-marker fa-fw text-muted");
    ...
    //         <span class = "text-muted small">5842 Hillcrest Rd</span>
    ...
    //         <span class = "fa fa-envelope fa-fw text-muted" data-toggle = "tooltip" title = "" data-original-title=""></span>
